			...
			settings: {
				...
				},
				{
					...
					aliases: {
						...
						"POST auth/forgot-password": "users.forgotPassword",
						"POST auth/reset-password": "users.resetPassword",
						"POST auth/social-login": "users.socialLogin",
						"POST auth/is-new-user": "users.isNewUser",
						"POST auth/check-license-number": "users.checkLicenseNumber",
						"POST auth/is-authenticated": "users.isAuthenticated",
						"PUT auth/setup-profile": "users.setupProfile",
						...
						"POST auth/delete-account-code": "users.deleteAccountCode",
