		...
		this.parseServiceSchema(Service.mergeSchemas({
			...
			settings: {
				...
				entityValidator: {
					...
					frontage_area: { type: "number", convert: true, optional: true, default: 0.0 },
					floor_area: { type: "number", convert: true,  optional: true, default: 0.0 },
			...
			actions: {
                ...
                update: {
					...
					async handler(ctx) {
						...
						console.log('CURRENT USER HERE===>',current_user);
